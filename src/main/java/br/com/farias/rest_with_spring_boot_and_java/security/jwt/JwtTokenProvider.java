package br.com.farias.rest_with_spring_boot_and_java.security.jwt;

import br.com.farias.rest_with_spring_boot_and_java.data.dto.security.TokenDTO;
import br.com.farias.rest_with_spring_boot_and_java.exception.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    @Value("${security.jwt.toke.expire-lenght:3600000}")
    private long validityInMillisconds = 3600000; // 1h
    ...
    public TokenDTO createAccessToken(String username, List<String> roles) {
        ...
        Date now = new Date();
        Date validity = new Date(now.getTime() + validityInMillisconds);
    ...
    private String getRefreshToken(String username, List<String> roles, Date now) {
        ...
        Date refreshTokenValidity = new Date(now.getTime() + (validityInMillisconds * 3));
        return JWT.create()
